...
const surveyforce_svelte_svelte_type_style_lang = "";
...
const comment_tooltip_svelte_svelte_type_style_lang = "";
const comment_map_svelte_svelte_type_style_lang = "";
const test_force_svelte_svelte_type_style_lang = "";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="Page-container"><div class="intro-container svelte-1wlroz3"><div class="title-img svelte-1wlroz3">${validate_component(Wm_img, "WMimg").$$render($$result, {}, {}, {})}</div> <div class="title-text svelte-1wlroz3" data-svelte-h="svelte-4mhht0"><h1 class="svelte-1wlroz3">To Our Mothers</h1> <p class="svelte-1wlroz3">Reflecting on Motherhood for BHM 2023</p></div></div> ${validate_component(BHM_intro, "BHM").$$render($$result, {}, {}, {})} ${validate_component(Sheroes, "She").$$render($$result, {}, {}, {})} ${validate_component(Family, "Fam").$$render($$result, {}, {}, {})} ${``} <div class="intro-container svelte-1wlroz3"><div class="title-img svelte-1wlroz3">${validate_component(Wm_img, "WMimg").$$render($$result, {}, {}, {})}</div> <div class="title-text svelte-1wlroz3" data-svelte-h="svelte-4mhht0"><h1 class="svelte-1wlroz3">To Our Mothers</h1> <p class="svelte-1wlroz3">Reflecting on Motherhood for BHM 2023</p></div></div></div>`;
});
export {
  Page as default
};
