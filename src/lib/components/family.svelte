...
<div class="facts-container">
  <div class= "wrapper">
    ...
    <div class= "fact">
      <article class="fact-text">
        <p>As of 2022 there are <span class="highlight">19.4 Million families <span> in the UK</p>
      </article>
      <div class="fact-img">
        <svg>
    ...
    <div class= "fact">
      <article class="fact-text">
        ...
        <p>That means we have around <span class="highlight">2.9 Million single parent families</span> in the UK</p>
      </article>
      <div class="fact-img">
    ...
    <div class= "fact">
      <article class="fact-text">
        ...
        <p><span class="highlight">Less than 1% of single parents are teenagers</span>, with majority of single parents tending to be in their mid forties </p>
      </article>
      <div class="fact-img">
        <Vbar/>
      </div>
    ...
    <div class= "fact">
      <article class="fact-text">
        <p> Looking at the chart here, the <span class="single-o">orange</span> represents proportion of co-parent households, where as the <span class="single-y">yellow</span> are the % of single parent households in that demographic. A smaller proportion of single parents tend to be from an Asian/Asian British background compared to couple parents (5% vs. 12%).</p>
        <p>However, <span class="highlight">a higher proportion of single parents tend to be from a Black/Black British (9%)</span> or Mixed/Multiple (3%) ethnic backgrounds compared to couple parents (4% and 1% respectively).</p>
      </article>
      <div class="fact-img">
        <Hbar/>
      </div>
    ...
    <div class= "fact">
      <article class="fact-text">
        ...
        <p><span class="highlight">9 out of 10 singe parents are mothers</span></p>
      </article>
      <div class="fact-img">
        <Pgrid/>
      </div>
